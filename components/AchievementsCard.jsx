...
const AchievementsCard = () => {
    return(<div className="flex-col-center w-[92vw] my-10 mx-auto gap-y-5 lg:flex-between lg:gap-x-5">
        {AchievementsData.map((item) => (
            <div key={item.title} className="flex-col-center-start w-full h-[180px] p-8 gap-y-2 shadow-[0_0_0px_4px_rgba(49,49,49,0.4)] border-2 border-grey-15 rounded-xl lg:h-[220px] xl:h-[250px] lg:w-[30%] xl:gap-y-7 xl:p-12">
