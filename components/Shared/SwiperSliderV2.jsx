...
export default function SwiperSliderV2 ({data}) {
  ...
  return (
    <div className="w-[95vw] h-fit mx-auto px-4 mt-7 lg:mt-10">
      <div className="flex-col-start w-full mt-15 mb-7">
        <h2 className='font-cards-md'>{data.name}</h2>
        <div className='flex-between w-full'>
          <p className='h-full inline-block font-paragraph text-white'>
      ...
      <div className="w-full h-full bg-grey-10 border-2 border-grey-15 p-5 rounded-xl">
        <Swiper
        ...
        <div className="w-full my-5 bg-grey-08 border-2 border-grey-15 p-2.5 rounded-xl">
        ...
        <div className='flex-between w-full p-2 bg-grey-08 rounded-full'>
