...
const NavExperienceCard = () => {
    return(<div className="flex-col-center w-[92vw] mx-auto my-10 gap-y-7 lg:grid lg:grid-cols-3 lg:gap-x-7">
        {NavExperienceData.map((item, index) => (
            <div key={item.step} className={`flex-col-start w-full lg:h-[370px] lg:flex-col-start-start ${index > 2 && 'max-lg:hidden'}`}>
                <h5 className="font-paragraph-md text-white font-light p-4 border-l-1 border-purple-60">{item.step}</h5>
