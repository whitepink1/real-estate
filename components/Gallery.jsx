    ...
    return(<div id="ourclients" className="w-[95vw] p-4 mx-auto lg:w-[92vw]">
        <div className="relative grid grid-cols-4 gap-2.5 w-full h-fit p-6 bg-grey-10 border-2 border-grey-15 rounded-xl bg-abstract lg:gap-5 lg:p-15">
            <div className="z-8 relative col-span-2 row-span-1">
                <img className="object-cover rounded-xl aspect-5/2" src="/Gallery/gallery1.jpg" alt="Gallery"/>
            </div>
            <div className="z-8 relative col-span-2 row-span-1">
                <img className="object-cover rounded-xl aspect-5/2" src="/Gallery/team1.jpg" alt="Gallery"/>
            </div>
            <div className="z-8 relative col-span-2 row-span-1">
                <img className="object-cover rounded-xl aspect-5/2" src="/Gallery/gallery2.jpg" alt="Gallery"/>
            </div>
            <div className="z-8 relative">
                <img className="object-cover rounded-xl h-full" src="/Gallery/team2.jpg" alt="Gallery"/>
            </div>
            <div className="z-8 relative">
                <img className="object-cover rounded-xl h-full" src="/Gallery/team3.jpg" alt="Gallery"/>
            </div>
            <div className="z-8 flex flex-col justify-center my-4 col-span-4 w-full lg:px-0 lg:col-span-2 lg:my-0">
                <Image src="/sparcle.svg" width={70} height={30} alt="Sparcles"/>
            ...
            <div className="z-8 relative col-span-4 lg:col-span-2 lg:row-span-1">
                <img className="object-cover rounded-xl aspect-7/4 lg:aspect-5/2" src="/Gallery/team4.jpg" alt="Gallery"/>
            </div>
        </div>
    </div>)
}
